<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"/var/www/html/public/../application/mobile/view/index/index.html";i:1660889134;}*/ ?>
<!DOCTYPE html><html><head><meta charset="UTF-8"><link rel="shortcut icon" href="/favicon.ico"/><title><?php echo $business_name; ?></title><meta name="viewport" content="width=device-width,minimum-scale=1.0,maximum-scale=1.0,user-scalable=no"/><script>
        YMWL_ROOT_URL = '<?php echo $baseroot; ?>';
    </script><link href="/assets/libs/layer/admin/layui.css?v=LK_DIY6.0.3" rel="stylesheet"><script src="/assets/libs/push/pusher.min.js?v=LK_DIY6.0.3" type="text/javascript"></script><script type="text/javascript" src="/assets/libs/jquery/jquery.min.js?v=LK_DIY6.0.3"></script><script src="/assets/libs/layui/layui.js?v=LK_DIY6.0.3" type="text/javascript"></script><script src="/assets/libs/jquery/jquery.cookie.js?v=LK_DIY6.0.3" type="text/javascript"></script><link rel="stylesheet" type="text/css" href="/assets/css/mobile/mobile.css?v=LK_DIY6.0.3"><script src="/assets/libs/jquery/jquery.form.min.js?v=LK_DIY6.0.3" type="text/javascript"></script><link href="/assets/libs/layer/skin/layer.css?v=LK_DIY6.0.3" type="text/css" rel="stylesheet"/><script src="/assets/libs/layer/layer.js?v=LK_DIY6.0.3" type="text/javascript"></script><script type="text/javascript" src="/assets/libs/webrtc/recorder.js?v=LK_DIY6.0.3"></script><script>
        $.cookie('state','off');
        ...
        var wolive_connect =function () {
            ...
            channels.bind('bind-wechat',function(data){
                $.ajax({
                    ...
                    dataType: 'json',
                    data:{"visiter_id":"<?php echo $visiter_id; ?>",'open_id':data.open_id,'business_id':'<?php echo $business_id; ?>','code':'<?php echo $code; ?>'},
                    type:"POST",   //请求方式
    ...
    </style></head><body><audio id="chat-message-audio"><source id="chat-message-audio-source" src="/upload/voice/default.mp3" type="audio/mpeg"/></audio><div id="container"><?php if($is_bind_wechat){ ?><div id="follow_topbar" class="clear"><div style="float: left"><i class="fa fa-bullhorn"></i>
            欢迎进入<?php echo $business_name; ?>，<br/>关注公众号，享专属服务
        </div><div style="float: right"><a class="layui-btn layui-btn-sm" id="followbtn">立即关注</a></div></div><?php } ?><div class="bg"><div class="dialog"><div class="title">评价客服</div><div class="dialog-body"><div style="margin-bottom: 20px;">请对我的服务进行评价，满意请打5星哦~</div><div class='evaluate-item evaluate-score' data-score="0"><span class="evaluate-title">服务态度态度</span><img class="star" data-id="1" src="/assets/images/index/star.png" alt=""><img class="star" data-id="2" src="/assets/images/index/star.png" alt=""><img class="star" data-id="3" src="/assets/images/index/star.png" alt=""><img class="star" data-id="4" src="/assets/images/index/star.png" alt=""><img class="star" data-id="5" src="/assets/images/index/star.png" alt=""></div><div class='evaluate-item' style="height: 80px;line-height: 1;margin-top: 10px;align-items: flex-start"><span style="display: inline-block;margin-right: 12px;white-space: nowrap">意见意见建议</span><textarea class="about-text" name="" id="" cols="30" rows="4"></textarea></div><div class="evaluate-btn"><button class="reset">取消</button><button class="submit">提交</button></div></div></div></div><div class="offline" {if $reststate== true}style="display: block;" {
    /if}><div class="dialog"><img class="close" src="/assets/images/index/close.png" onclick="$(this).parents('.offline').hide();"><div class="dialog-body"><div style="margin-bottom: 20px;"><?php echo nl2br($restsetting['reply']); ?></div><?php if($restsetting['name_state'] == 'open'): ?><div class='offline-item'><div class="offline-title">姓名</div><input placeholder="请输入您的姓名" id="offline_name" type="text"></div><?php endif; if($restsetting['tel_state'] == 'open'): ?><div class='offline-item'><div class="offline-title">联系方式</div><input placeholder="请输入您的联系方式" id="offline_mobile" type="number"
                       onkeypress='return( /[\d]/.test(String.fromCharCode(event.keyCode)))'></div><?php endif; if(($restsetting['name_state'] == 'open') || ( $restsetting['tel_state'] == 'open')): ?><div class="evaluate-btn"><button class="reset">取消</button><button class="submit">提交</button></div><?php endif; ?></div></div></div><a href="javascript:history.back(-1)" class="fanhui"><i class="layui-icon" style="position: absolute;left:10px;font-size: 20px;z-index: 999">&#xe603;</i></a><div class="header" style="background-color: #<?php echo $theme; ?>"><span id="services" style="color: #FFF;"></span><span id="status"></span></div><div class="content" id="wrap" style="background-color: rgb(247, 247, 247);"><a href="<?php echo url('index/report',['business_id'=>$business_id]); ?>"
       style="position: fixed;right: 6px;top:56px;width: 3em;height: 3em;background-color: rgba(0,0,0,0.3);border-radius: 50%;text-align: center;line-height: 3em;color: #ffffff;z-index: 99999999;">投诉</a><div style="height: 55px;width: 100%;"></div><ul id="log" class="conversation"></ul><div style="height: 94px;width: 100%;"></div></div><div class="keyword"><div class="swiper-wrapper" id="question_key_list"></div></div><div class="foot_all" style="position:fixed;bottom:0;width: 100%;height: 94px;padding:0;z-index: 999"><div class="tool_box"><div class="wl_faces_content"><div class="wl_faces_main"></div></div></div><div class="foot_msg"><div class="footer"><input type="text" id="text_in" placeholder="发消息..." class="layui-input"/><button class="layui-btn layui-btn-normal send-btn" style="background-color: #<?php echo $theme; ?>"
                    onclick="send()">发送
            </button></div><div class="msg-toolbar"><a id="face_icon" href="javascript:" onclick="faceon()"><img src="/assets/images/admin/B/smile.png" alt=""></a><?php if($atype == 'open'): ?><a onclick="getaudio()"><img src="/assets/images/admin/B/smile.png" alt=""></a><?php endif; ?><a id="images" href="javascript:"><form id="picture" enctype="multipart/form-data"><div class="layui-box input-but  size"><img src="/assets/images/admin/B/photo.png" alt=""><input type="file" name="upload" class="fileinput" onchange="put()"/></div></form></a><a id="files" href="javascript:"><form id="file" enctype="multipart/form-data"><div class="layui-box input-but  size"><img src="/assets/images/admin/B/file.png" alt=""><input type="file" name="folder" class="fileinput" onchange="putfile()"/></div></form></a><a onclick="hint()" id="clickbf" style="margin-top: 7px;"><i class="layui-icon state-mp3"
                                                                         style="font-size: 28px;cursor: pointer;color: #999999">&#xe685;</i></a></div></div></div></div><script type="text/javascript" src="/assets/js/moblie/mochat.js?v=LK_DIY6.0.3"></script><script>
    function isWeiXin(){
