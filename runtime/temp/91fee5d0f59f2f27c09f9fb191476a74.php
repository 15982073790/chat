<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"/data/wwwroot/dev/chat.profittravel.com/public/../application/layer/view/index/index.html";i:1619141972;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <script>
        ...
        ",'open_id':data.open_id,'business_id':'<?php echo $business_id; ?>
        ','parameter':'<?php echo json_encode($_GET); ?>'},
                    type:"POST",   //请求方式
...
<div id="container"><?php if ($is_bind_wechat) { ?>
        <div id="follow_topbar" class="clear" style="top:60px">
        <div style="float: left"><i class="fa fa-bullhorn"></i>
    ...
    <div class="header" style="width: 100%;height: 60px;position: relative;background-color: #<?php echo $theme; ?>">
        <div class="infoBar" style="position: absolute;width: 100%;height: 100%"><img id="img_head"
                                                                                      src="/assets/images/index/workerman_logo.png"
                                                                                      style="width: 46px;height: 46px;border-radius: 50%;position: absolute;left: 10px;top: 7px;"><span
                    id='services' style="position: absolute;left: 60px;top: 7px;height: 46px;line-height: 46px;"></span>
        </div>
    </div>
