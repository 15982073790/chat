                ...
                <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief"
                    ...
                    <ul class="layui-tab-title" style="height: 50px;border: 0;">
                        <li class="layui-this" style="width: 50%;color: #555555;height: 50px;line-height: 55px;">
                            当前对话<span class="line"></span></li>
                        <li style="width: 50%;color: #555555;height: 50px;line-height: 55px;">排队列表
                    ...
                    <div class="layui-tab-content" style="padding: 0px;">
                        <!--<img onclick="clearList()" class="clear-btn" src="/assets/images/index/clear.png"></img><span class="reply-border clear"></span><span class="reply-about clear">清空聊天列表</span>-->
                ...
                <div class="chatbox hide" style="width: 100%;height: 100%;padding-bottom: 242px">
                    ...
                    <div class="footer">
                        <div class="tool_box">
                            <div class="wl_faces_content">
                                <div class="wl_faces_main">
                                    <ul>
                                        <li><a href="javascript:;"><img title="羊驼" src="/upload/emoji/emo_01.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="神马" src="/upload/emoji/emo_02.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="浮云" src="/upload/emoji/emo_03.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="给力" src="/upload/emoji/emo_04.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="围观" src="/upload/emoji/emo_05.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="威武" src="/upload/emoji/emo_06.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="熊猫" src="/upload/emoji/emo_07.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="兔子" src="/upload/emoji/emo_08.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="奥特曼" src="/upload/emoji/emo_09.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="囧" src="/upload/emoji/emo_10.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="互粉" src="/upload/emoji/emo_11.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="礼物" src="/upload/emoji/emo_12.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="微笑" src="/upload/emoji/emo_13.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="嘻嘻" src="/upload/emoji/emo_14.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="哈哈" src="/upload/emoji/emo_15.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="可爱" src="/upload/emoji/emo_16.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="可怜" src="/upload/emoji/emo_17.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="抠鼻" src="/upload/emoji/emo_18.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="吃惊" src="/upload/emoji/emo_19.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="害羞" src="/upload/emoji/emo_20.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="调皮" src="/upload/emoji/emo_21.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="闭嘴" src="/upload/emoji/emo_22.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="鄙视" src="/upload/emoji/emo_23.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="爱你" src="/upload/emoji/emo_24.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="流泪" src="/upload/emoji/emo_25.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="偷笑" src="/upload/emoji/emo_26.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="亲亲" src="/upload/emoji/emo_27.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="生病" src="/upload/emoji/emo_28.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="太开心" src="/upload/emoji/emo_29.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="白眼" src="/upload/emoji/emo_30.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="右哼哼" src="/upload/emoji/emo_31.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="左哼哼" src="/upload/emoji/emo_32.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="嘘" src="/upload/emoji/emo_33.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="衰" src="/upload/emoji/emo_34.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="委屈" src="/upload/emoji/emo_35.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="呕吐" src="/upload/emoji/emo_36.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="打哈欠" src="/upload/emoji/emo_37.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="抱抱" src="/upload/emoji/emo_38.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="怒" src="/upload/emoji/emo_39.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="问号" src="/upload/emoji/emo_40.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="馋" src="/upload/emoji/emo_41.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="拜拜" src="/upload/emoji/emo_42.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="思考" src="/upload/emoji/emo_43.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="汗" src="/upload/emoji/emo_44.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="打呼" src="/upload/emoji/emo_45.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="睡" src="/upload/emoji/emo_46.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="钱" src="/upload/emoji/emo_47.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="失望" src="/upload/emoji/emo_48.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="酷" src="/upload/emoji/emo_49.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="好色" src="/upload/emoji/emo_50.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="生气" src="/upload/emoji/emo_51.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="鼓掌" src="/upload/emoji/emo_52.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="晕" src="/upload/emoji/emo_53.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="悲伤" src="/upload/emoji/emo_54.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="抓狂" src="/upload/emoji/emo_55.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="黑线" src="/upload/emoji/emo_56.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="阴险" src="/upload/emoji/emo_57.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="怒骂" src="/upload/emoji/emo_58.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="心" src="/upload/emoji/emo_59.gif"/></a>
                                        </li>
                                        <li><a href="javascript:;"><img title="伤心" src="/upload/emoji/emo_60.gif"/></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="msg-toolbar" style="background: #fff;border: none;"><a id="face_icon"
                                                                                           onclick="faceon()"><img
                                        src="/assets/images/admin/B/smile.png" alt="表情" title="表情"></a><a>
                            ...
                            <a href="javascript:getblack()"><img src="/assets/images/admin/B/blacklist.png" alt="移入黑名单"
                                                                 title="移入黑名单"></a><a onclick="getswitch()"><img
                                        src="/assets/images/admin/B/transfer.png" alt="客服转接" title="客服转接"></a><a
                                    onclick="gethistory()"><img src="/assets/images/admin/B/record.png" alt="历史记录"
                                                                title="历史记录"></a><a onclick="toEvaluate()"><img
                                        src="/assets/images/admin/B/toEvaluate.png" alt="推送评价" title="推送评价"></a><a
                ...
                <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief"
                    ...
                    <ul class="layui-tab-title" style="height: 50px;border-bottom: 0;background-color: #f7f7f7">
                        <li class="layui-this" style="width: 33%;height: 50px;line-height: 50px;color: #555555">
                            访客信息<span class="line"></span></li>
                        <li style="width: 33%;height: 50px;line-height: 50px;color: #555555">黑名单<span
                                    class="line"></span></li>
                        <li style="width: 34%;height: 50px;line-height: 50px;color: #555555">快捷回复<span
                                    class="line"></span></li>
                    </ul>
                    <div class="layui-tab-content" style="padding: 16px;height: 100%">
                        <div class="layui-tab-item layui-show">
                            <div class="" style="margin:24px;color: #555555;">
                                ...
                                <div style="margin-top: 12px;"> 来源：<span class="record"></span></div>
                                <div style="margin-top: 14px; font-size: 12px;"> 地区：<span class="ipdizhi"></span> 【<span
                                            class="iparea"></span>】
                                </div>
                                <div style="margin-top: 14px;"> 状态：<span id="v_state" style="font-size: 10px;"></span>
                                </div>
                                <div style="margin-top: 14px;"> 上次登录时间：<span
                                            id="last_login_time" style="font-size: 10px;"></span></div>
                                <div style="margin-top: 14px;"> 登录次数：<span
                                            id="login_times" style="font-size: 10px;"></span></div>
                                <div style="margin-top: 14px;"> 登录设备：<span
                                            id="login_device" style="font-size: 10px;"></span></div>
                                <div style="margin-top: 14px;"> 姓名：<input type="text" id="name" placeholder="姓名填写后自动保存"
                                                                          class="layui-input" onblur="saveinfo()"/>
                                </div>
                                <div style="margin-top: 14px;"> 电话：<input type="text" id="tel" placeholder="电话填写后自动保存"
                                                                          class="layui-input" onblur="saveinfo()"/>
                                </div>
                                <div style="margin-top: 14px;"> 备注：<textarea id="comment" placeholder="备注信息，填写后自动保存"
                                                                             class="layui-input" onblur="saveinfo()"
