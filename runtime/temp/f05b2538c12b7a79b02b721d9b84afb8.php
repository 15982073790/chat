<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"/data/wwwroot/dev/chat.profittravel.com/public/../application/admin/view/index/index.html";i:1619138110;s:81:"/data/wwwroot/dev/chat.profittravel.com/application/admin/view/public/header.html";i:1620746200;s:81:"/data/wwwroot/dev/chat.profittravel.com/application/admin/view/public/footer.html";i:1612957206;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<div id="layout-center">
        ...
        <div class="layui-fluid">
            <div class="layui-col-sm12">
                <div class="layui-card">
                    <div class="layui-card-header" style="font-size:20px;"> 数据总览
                    </div>
                </div>
            </div>
            <div class="layui-row layui-col-space15">
                <div class="layui-col-sm6 layui-col-md3">
                    <div class="layui-card">
                        <div class="layui-card-header"> 当前咨询用户数
                            <span class="layui-badge layui-bg-blue layuiadmin-badge">咨询</span></div>
                        <div class="layui-card-body layuiadmin-card-list"><p
                                    class="layuiadmin-big-font"><?php echo $talking; ?></p><?php if ($admins['level'] == 'super_manager'): ?>
                                <p>                当前在线客服数
                                <span class="layuiadmin-span-color"><?php echo $services; ?><i class="layui-icon">&#xe63a;</i></span>
                                </p><?php else: ?><p>                当前在线用户数
                                <span class="layuiadmin-span-color"><?php echo $visiter_online; ?><i class="layui-icon">&#xe63a;</i></span>
                                </p><?php endif; ?></div>
                    </div>
                </div>
                <div class="layui-col-sm6 layui-col-md3">
                    <div class="layui-card">
                        <div class="layui-card-header"> 当前排队用户数
                            <span class="layui-badge layui-bg-cyan layuiadmin-badge">排队</span></div>
                        <div class="layui-card-body layuiadmin-card-list"><p
                                    class="layuiadmin-big-font"><?php echo $waiter; ?></p>
                            <p> 接待总用户数
                                <span class="layuiadmin-span-color"><?php echo $getinall; ?><i class="layui-icon">&#xe610;</i></span>
                            </p></div>
                    </div>
                </div>
                <div class="layui-col-sm6 layui-col-md3">
                    <div class="layui-card">
                        <div class="layui-card-header"> 今日聊天消息数
                            <span class="layui-badge layui-bg-green layuiadmin-badge">消息</span></div>
                        <div class="layui-card-body layuiadmin-card-list"><p
                                    class="layuiadmin-big-font"><?php echo $nowchats; ?></p>
                            <p> 聊天消息总数
                                <span class="layuiadmin-span-color"><?php echo $chatsall; ?><i class="layui-icon">&#xe667;</i></span>
                            </p></div>
                    </div>
                </div>
                <div class="layui-col-sm6 layui-col-md3">
                    <div class="layui-card">
                        <div class="layui-card-header"> 今日评价用户数
                            <span class="layui-badge layui-bg-orange layuiadmin-badge">评价</span></div>
                        <div class="layui-card-body layuiadmin-card-list"><p
                                    class="layuiadmin-big-font"><?php echo $nowcomments; ?></p>
                            <p> 总评价用户数
                                <span class="layuiadmin-span-color"><?php echo $allcomments; ?><i class="layui-icon">&#xe600;</i></span>
                            </p></div>
                    </div>
                </div>
            </div>
            <div class="layui-col-sm12">
                <div class="layui-card">
                    <div class="layui-card-header" style="font-size:20px; margin-top: 20px;"> 今日客服服务数据趋势
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">var myChart = echarts.init(document.getElementById('wolivedatas'));
...
var option = {
    ...
    series: [

        {
            ...
            type: 'line',
            smooth: true,
            data: [<?php echo $chatsdata[0]; ?>, <?php echo $chatsdata[1]; ?>, <?php echo $chatsdata[2]; ?>
        , <?php echo $chatsdata[3]; ?>, <?php echo $chatsdata[4]; ?>, <?php echo $chatsdata[5]; ?>
        , <?php echo $chatsdata[6]; ?>, <?php echo $chatsdata[7]; ?>, <?php echo $chatsdata[8]; ?>]
        },
        {
            name: '接入会话总量',
            type: 'line',
            smooth: true,
            data: [<?php echo $getindata[0]; ?>, <?php echo $getindata[1]; ?>, <?php echo $getindata[2]; ?>
        , <?php echo $getindata[3]; ?>, <?php echo $getindata[4]; ?>, <?php echo $getindata[5]; ?>
        , <?php echo $getindata[6]; ?>, <?php echo $getindata[7]; ?>, <?php echo $getindata[8]; ?>]
        }
    ]
};
