        ...
        var index = layer.open({
            ...
            ,cancel: function(){
                    ...
                    数据总览
                        ...
                        当前咨询用户数
                        <span class="layui-badge layui-bg-blue layuiadmin-badge">咨询</span></div><div class="layui-card-body layuiadmin-card-list"><p class="layuiadmin-big-font"><?php echo $talking; ?></p><?php if($admins['level']=='super_manager'): ?><p>
                            当前在线客服数
                        ...
                        当前排队用户数
                        <span class="layui-badge layui-bg-cyan layuiadmin-badge">排队</span></div><div class="layui-card-body layuiadmin-card-list"><p class="layuiadmin-big-font"><?php echo $waiter; ?></p><p>
                            接待总用户数
                        ...
                        今日聊天消息数
                        <span class="layui-badge layui-bg-green layuiadmin-badge">消息</span></div><div class="layui-card-body layuiadmin-card-list"><p class="layuiadmin-big-font"><?php echo $nowchats; ?></p><p>
                            聊天消息总数
                        ...
                        今日评价用户数
                        <span class="layui-badge layui-bg-orange layuiadmin-badge">评价</span></div><div class="layui-card-body layuiadmin-card-list"><p class="layuiadmin-big-font"><?php echo $nowcomments; ?></p><p>
                            总评价用户数
