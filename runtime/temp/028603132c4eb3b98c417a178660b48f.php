    ...
    <div id="container" style="background-color: #fff;padding: 16px;">
        <div class="front">
            <div class="my-setting">
                <div class="head">
                    <div class="title"> 部署网页组件（推荐）：网页咨询组件同时支持桌面网站和移动网站，提供强大的用户行为采集能力和系统对接能力
                    </div>
                </div>
                <br/>
                <div class="contents"> 聊天框样式：
                ...
                <div class="layui-card" style="background-color: #F3F3F3;" id="diy-kf-site">
                    ...
                    <div class="layui-card-body">
                        <form class="layui-form" id="form-diy">
                            ...
                            <div class="layui-form-item"><label class="layui-form-label"
                                                                style="width: 120px">主题颜色</label>
                                <div class="layui-input-inline"><input type="hidden" name="theme" placeholder="请选择颜色"
                ...
                <div class="method">
                    <div id="codearea" class="hide">
                        ...
                        <pre id="personal" class="copy-js-content hide" readonly="" style="padding-bottom: 2em;"><span
                                    style="color: red">我的专属链接(将二维码保存下来，进行推广，客户通过微信扫码即可和客服聊天):</span><p></p><div
                                    class="qrcode_wrap_zs"></div></pre>
                        <pre id="wolive-js" class="copy-js-content" readonly>                            部署如下代码
                            <div class="layui-code"></div></pre>
                        <pre id="frontjs" class="copy-js-content hide" style="height: 250px">                            部署如下代码
                            <div class="layui-code"></div></pre>
                        <pre id="minjs" class="copy-js-content hide" style="height: 280px;color:red;">                        如果需要添加自身网站用户数据，请部署到上面代码之前，按注释要求添加：
