<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"/var/www/html/public/../application/index/view/index/index.html";i:1660889134;}*/ ?>
<!DOCTYPE html><html lang="zh"><head><meta charset="UTF-8"><link rel="shortcut icon" href="/favicon.ico"/><title><?php echo $business_name; ?></title><script>
        YMWL_ROOT_URL = '<?php echo $baseroot; ?>';
    </script><script type="text/javascript" src="/assets/libs/jquery/jquery.min.js?v=LK_DIY6.0.3"></script><link href="/assets/css/index/chat.css?v=LK_DIY6.0.3" type="text/css" rel="stylesheet"/><script src="/assets/libs/jquery/jquery.cookie.js?v=LK_DIY6.0.3" type="text/javascript"></script><script src="/assets/libs/jquery/jquery.form.min.js?v=LK_DIY6.0.3" type="text/javascript"></script><link href="/assets/libs/layer/admin/layui.css?v=LK_DIY6.0.3" rel="stylesheet"><script src="/assets/libs/layui/layui.js?v=LK_DIY6.0.3" type="text/javascript"></script><link href="/assets/libs/layer/skin/layer.css?v=LK_DIY6.0.3" type="text/css" rel="stylesheet"/><script src="/assets/libs/layer/layer.js?v=LK_DIY6.0.3" type="text/javascript"></script><script src="/assets/libs/swiper-4.3.3.min.js?v=LK_DIY6.0.3" type="text/javascript"></script><script src="/assets/libs/push/pusher.min.js?v=LK_DIY6.0.3" type="text/javascript"></script><script src="/assets/libs/adapter.js?v=LK_DIY6.0.3"></script><script type="text/javascript" src="/assets/libs/webrtc/recorder.js?v=LK_DIY6.0.3"></script><link rel="stylesheet" href="/assets/libs/myeditor/css/editormd.css?v=LK_DIY6.0.3"/><style type="text/css">        .layui-layer-content {
            overflow: hidden;
        }
        ...
        var wolive_connect =function () {
            ...
            channels.bind('bind-wechat',function(data){
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    data:{"visiter_id":"<?php echo $visiter_id; ?>",'open_id':data.open_id,'business_id':'<?php echo $business_id; ?>','code':'<?php echo $_GET["code"]; ?>'},
                    type:"POST",   //请求方式
...
</script><div class="bg"><div class="dialog"><img class="close" src="/assets/images/index/close.png" alt=""><div class="title">评价客服</div><div class="dialog-body"><div style="margin-bottom: 20px;">请对我的服务进行评价，满意请打5星哦~</div><div class='evaluate-item evaluate-score' data-score="0"><span class="evaluate-title">服务态度态度</span><img class="star" data-id="1" src="/assets/images/index/star.png" alt=""><img class="star" data-id="2" src="/assets/images/index/star.png" alt=""><img class="star" data-id="3" src="/assets/images/index/star.png" alt=""><img class="star" data-id="4" src="/assets/images/index/star.png" alt=""><img class="star" data-id="5" src="/assets/images/index/star.png" alt=""><span class="evaluate-text"></span></div><div class='evaluate-item evaluate-score' data-evaluate-itemscore="0"><span class="evaluate-title">回复速度态度</span><img class="star" data-id="1" src="/assets/images/index/star.png" alt=""><img class="star" data-id="2" src="/assets/images/index/star.png" alt=""><img class="star" data-id="3" src="/assets/images/index/star.png" alt=""><img class="star" data-id="4" src="/assets/images/index/star.png" alt=""><img class="star" data-id="5" src="/assets/images/index/star.png" alt=""><span class="evaluate-text">满意</span></div><div class='evaluate-item evaluate-score' data-score="0"><span class="evaluate-title">总满意态度度</span><img class="star" data-id="1" src="/assets/images/index/star.png" alt=""><img class="star" data-id="2" src="/assets/images/index/star.png" alt=""><img class="star" data-id="3" src="/assets/images/index/star.png" alt=""><img class="star" data-id="4" src="/assets/images/index/star.png" alt=""><img class="star" data-id="5" src="/assets/images/index/star.png" alt=""><span class="evaluate-text">满意</span></div><div class='evaluate-item' style="height: 80px;line-height: 1;margin-top: 10px;align-items: flex-start"><span class="evaluate-title" style="min-width:60px;text-align: right">意见反馈态度</span><textarea class="about-text" name="" id="" cols="30" rows="5"></textarea></div><div class="evaluate-btn"><button class="submit">提交</button><button class="reset">取消</button></div></div></div></div><?php $restsetting['reply'] = isset($restsetting['reply'])?$restsetting['reply']:'';$restsetting['name_state'] = isset($restsetting['name_state'])?$restsetting['name_state']:'';$restsetting['tel_state'] = isset($restsetting['tel_state'])?$restsetting['tel_state']:'';?><div class="offline" {if $reststate== true}style="display: block;" {
/if}><div class="dialog" style="width: 370px;"><img class="close" src="/assets/images/index/close.png"><div class="dialog-body" style="padding:25px;padding-right: 45px;"><div style="margin-bottom: 20px;"><?php echo nl2br($restsetting['reply']); ?></div><?php if($restsetting['name_state'] == 'open'): ?><div class='offline-item'><span class="offline-title" style="min-width:60px;text-align: right">姓名</span><input id="offline_name" type="text"></div><?php endif; if($restsetting['tel_state'] == 'open'): ?><div class='offline-item'><span class="offline-title" style="min-width:60px;text-align: right">联系方式</span><input id="offline_mobile" type="number"
                   onkeypress='return( /[\d]/.test(String.fromCharCode(event.keyCode)))'></div><?php endif; if(($restsetting['name_state'] == 'open') || ( $restsetting['tel_state'] == 'open')): ?><div class="evaluate-btn"><button class="submit">提交</button><button class="reset">取消</button></div><?php endif; ?></div></div></div><div style="width: 80%;height: 90%;min-height:500px;min-width:900px;margin: 2% auto;position: relative;"><!--  对话框头部 --><div class="header grey12" style="background-color:#<?php echo $theme; ?>;"><span id="services" style="color: #ffffff;margin-left: 32px;"></span><span id='service_icon' class="layui-badge-dot layui-bg-green hidden"
              style="display:inline-block;width: 8px;height: 8px;border-radius: 8px;margin-left: 5px;"></span></div><div id="container" style="width: 65%;height: 90%;position: absolute;top:64px; "><?php if($is_bind_wechat){ ?><div id="follow_topbar"><i class="fa fa-bullhorn"></i>
            欢迎进入<?php echo $business_name; ?>，关注公众号，享专属服务 <a class="layui-btn layui-btn-sm" id="followbtn">立即关注</a></div><?php } ?><div class="workarea"><!--  对话内容部分 --><div class="content" id="wrap"><ul class="conversation"></ul><div style="height: 20px"></div></div><div class="footer widths"><script type="text/javascript">
              ...
              var hint=function(){
                   ...
                   if(state == "on"){
                       ...
                       layer.msg('开启提示音',{end:function(){
                ...
                </script><div class="keyword"><div class="swiper-wrapper" id="question_key_list"></div></div><img class="toggle toggle-right" style="right: 1%" src="/assets/images/index/right.png" alt=""><img class="toggle toggle-left" style="left: 1%" src="/assets/images/index/left.png" alt=""><div class="tool_box"><div class="wl_faces_content"><div class="wl_faces_main"></div></div></div><div class="msg-input"><textarea id="text_in" class="edit-ipt"
                          ...
                          contenteditable="true" hidefocus="true" tabindex="0"></textarea></div><div class="msg-toolbar-footer grey12"><a onclick="send()" class="layui-btn msg-send-btn" style="background-color:#<?php echo $theme; ?>;">
                        发送
                    </a><a id="showinfo" class="showinfo" style="background-color:#<?php echo $theme; ?>;"><div style="height: 10px;border-left: 1px solid #FFF;margin-top: 8px;padding: 7px 15px"><img src="/assets/images/admin/B/up-menu.png" alt=""></div></a></div><div class="msg-toolbar"><a id="face_icon" href="javascript:" onclick="faceon()"><img src="/assets/images/admin/B/smile.png"
                                                                                 alt=""></a><?php if($type == 'open'): ?><a id="video" style="cursor: pointer;" onclick="getvideo()"><i class="layui-icon"
                                                                                   style="font-size: 26px;">&#xe6ed;</i></a><?php endif; if($atype == 'open'): ?><a onclick="getaudio()"><i class="layui-icon" style="font-size: 22px;cursor: pointer;">&#xe688;</i></a><?php endif; ?><a id="images" href="javascript:"><form id="picture" enctype="multipart/form-data"><div class="layui-box input-but  size"><img src="/assets/images/admin/B/photo.png" alt=""><input type="file" name="upload" class="fileinput" onchange="put()"/></div></form></a><a id="files" href="javascript:"><form id="file" enctype="multipart/form-data"><div class="layui-box input-but  size"><img src="/assets/images/admin/B/file.png" alt=""><input type="file" name="folder" class="fileinput" onchange="putfile()"/></div></form></a><a onclick="hint()" id="clickbf" style="margin-top: -5px;"><i class="layui-icon state-mp3"
                                                                                  style="font-size: 25px;cursor: pointer;color: #999999">&#xe685;</i></a><a onmouseover="info()" id="paste" style="position:absolute; right:5%;width: 115px"><img
                            src="/assets/images/admin/B/screen.png" alt=""> 怎样发截图？</a></div></div></div></div><!-- 浮层 --><div id='fuceng' class="hide"
         style="background: #f7f7f7;height: 68px;position: absolute;bottom: 85px;right: 36%;z-index: 9999;border-radius: 8px;padding: 8px 0"><ul style="width: 100%;height: 60px;"><li class="fuceng-li" onclick="choose(this)" name='1'><img id='type1' class="layui-icon selecte-icon"
                                                                       src="/assets/images/admin/B/selected.png"
                                                                       alt=""><span>按Enter键发送消息，Ctrl+Enter换行</span></li><li class="fuceng-li selected-li" onclick="choose(this)" name='2'><img id='type2'
                                                                                   class="layui-icon selecte-icon"
                                                                                   src="/assets/images/admin/B/selected.png"
                                                                                   alt=""><span>按Ctrl+Enter键发送消息，Enter换行</span></li></ul></div><div id='xxxx'
         style="display:none;width: 34.9%;height: 90%;position: absolute;top:64px;left: 65%;background: #fff;border: 1px solid #ddd;overflow-x: hidden;"><div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief"
             style="margin: 0px;height: 50px;background-color: #f7f7f7"><ul class="layui-tab-title" id="tablist" style="height: 50px;border-bottom: 0;width: 100%"><li class="layui-this">常见问题</li></ul><div class="layui-tab-content" id="tabcontent"><div class="layui-tab-item layui-show" id="question_list" style="width: 100%;overflow-y: auto;"></div><!--  <div class="layui-tab-item" id="connect_list" style="width: 100%;overflow-y: auto;"></div> --></div></div></div></div><script src="/assets/js/index/inchat.js?v=LK_DIY6.0.3"></script><script type="text/javascript" src="/assets/js/video.js?v=LK_DIY6.0.3"></script><script type="text/javascript">
